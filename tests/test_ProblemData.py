...
def test_same_machines_with_modes_and_multiple_machines(solver: str):
    """
    Tests that the same machines constraint is respected when tasks have
    ...
    # ... which forces the tasks to be scheduled on the same machines:
