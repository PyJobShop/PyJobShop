...
Conversations about development and issues take place in the [GitHub repository](https://github.com/PyJobShop/PyJobShop/).
...
Now, change into the PyJobShop directory, and set up the virtual environment using [uv](https://github.com/astral-sh/uv) (v0.5.4 or above):
...
!!! note
    ...
    See the [installation instructions](../setup/installation.md) page for more details about installing CP Optimizer.

!!! note
    If you use [pre-commit](https://pre-commit.com/), you can use our pre-commit configuration file to set that up too.
    Simply type:
...
If you are new to contributing, do not worry about meeting all requirements initially.
We encourage you to open draft PRs early and we will guide you through the process.
