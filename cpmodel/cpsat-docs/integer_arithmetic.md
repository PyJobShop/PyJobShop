...
-   **Python**: `model.NewIntVarFromDomain(cp_model.Domain.FromValues([1, 3, 4, 6]), 'x')`

Variables can also be created using a list of intervals. Below, the variable
created is constrained to be 1, 2, 4, 5, or 6:

-   **Python**: `model.NewIntVarFromDomain(cp_model.Domain.FromIntervals([[1, 2], [4, 6]]), 'x')`

### Boolean variables

To create a Boolean variable, use the `NewBoolVar` method:
...
### Python linear constraints and linear expressions

**Python** CP-SAT API supports general linear arithmetic (+, \*, -,
