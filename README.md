...
> [!TIP]
> If you are new to scheduling or constraint programming, you might benefit from first reading the [introduction to scheduling](https://pyjobshop.readthedocs.io/stable/setup/intro_to_scheduling.html) and [introduction to constraint programming](https://pyjobshop.readthedocs.io/stable/setup/intro_to_cp.html) pages.
...
See [our documentation](https://pyjobshop.readthedocs.io/stable/setup/installation.html) for instructions on how to install PyJobShop with CP Optimizer.
...
Please have a look [here](https://pyjobshop.readthedocs.io/stable/dev/contributing.html) to get started. 
...
When writing your issue or discussion, please follow the instructions [here](https://pyjobshop.readthedocs.io/stable/setup/getting_help.html).
